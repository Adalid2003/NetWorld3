...
document.getElementById('search-form').addEventListener('submit', function (event) {
    ...
    searchRows(API_COMPRAS, 'search-form');
});
...
function openUpdateDialog(id) {
    ...
    instance.open();
    // Se asigna el título para la caja de dialogo (modal).
    document.getElementById('modal-title').textContent = 'Actualizar compra';
            ...
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    if (response.dataset.estado_compra) {
                        ...
                        document.getElementById('estado_compra').checked = false;
                    }
...
document.getElementById('save-form').addEventListener('submit', function (event) {
    ...
    if (document.getElementById('id_compra').value) {
        action = 'update';
    } else {
        action = 'create';
    }
    saveRow(API_COMPRAS, action, 'save-form', 'save-modal');
});
...
function openDeleteDialog(id) {
    ...
    confirmDelete(API_COMPRAS, data);
}