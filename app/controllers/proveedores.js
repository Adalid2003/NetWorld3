...
const API_PROVEEDORES= '../../app/api/dashboard/proveedores.php?action=';
...
function openCreateDialog() {
    ...
    document.getElementById('modal-title').textContent = 'Ingresar Proveedor';
        ...
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    document.getElementById('nombre_proveedor').value = response.dataset.Nombre_proveedor;
                    document.getElementById('telefono_prov').value = response.dataset.Telefono_proveedor;
                    document.getElementById('direccion_prov').value = response.dataset.Direccion_proveedor;
