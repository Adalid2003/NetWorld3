...
function fillTable(dataset) {
    ...
    dataset.map(function (row) {
        ...
        content += `
            <tr>
                <td><img src="../../resources/img/categorias/${row.imagen_catoria}" class="materialboxed" height="100"></td>
                <td>${row.nombre_categoria}</td>
                <td>${row.descripcion_categoria}</td>
                <td>
                    <a href="#" onclick="openUpdateDialog(${row.id_categoria})" class="btn waves-effect green darken-1 tooltipped" data-tooltip="Actualizar"><i class="material-icons">sync</i></a>
