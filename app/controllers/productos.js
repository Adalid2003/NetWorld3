...
function fillTable(dataset) {
    ...
    dataset.map(function (row) {
        ...
        (row.estado_producto) ? icon = 'lock_open' : icon = 'lock_outline';
        ...
        content += `
            <tr>
                ...
                <td>
                    <a href="#" onclick="openUpdateDialog(${row.id_producto})" class="btn waves-effect  green darken-1  tooltipped" data-tooltip="Actualizar"><i class="material-icons">sync</i></a>
...
function openCreateDialog() {
    ...
    document.getElementById('modal-title').textContent = 'Ingresar un producto';
...
function openUpdateDialog(id) {
    ...
    instance.open();
    // Se asigna el título para la caja de dialogo (modal).
    document.getElementById('modal-title').textContent = 'Actualizar un producto';
