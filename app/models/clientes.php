...
class Clientes extends Validator
{
    ...
    */
    ...
    {
        // Se hace la consullta para llevar a cabo la acción
        $sql = 'INSERT INTO historial_sesion_c(ordenador, fecha, id_cliente)
                VALUES(?,  current_timestamp, ?)';
        $params = array($_SERVER['SERVER_SOFTWARE'], $_SESSION['id_cliente']);
        return Database::executeRow($sql, $params);
    }
    ...
    {
        // Se hace la consullta para llevar a cabo la acción
        $sql = 'SELECT id_sesion_c, ordenador, fecha, nombre_cliente
